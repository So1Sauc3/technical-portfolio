public class CoalOre extends BlockItem {
	...
	private static final String DEFAULT_TEXTURE = "textures\\BlockItem\\coal_ore.png";
	...
	public Item update(Item itm) {
		if (itm instanceof ToolItem) return new Air();
		else return null;
	}
