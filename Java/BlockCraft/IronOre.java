public class IronOre extends BlockItem {
	private static final String ID = "iron_ore";
	private static final int DEFAULT_STACK_LIMIT = 64;
	private static final int DEFAULT_STACK = 1;
	private static final String DEFAULT_TEXTURE = "textures\\BlockItem\\iron_ore.png";
	...
	public Item update(Item itm) {
		if (itm instanceof ToolItem && ((ToolItem)itm).getMineStrength()>0) return new Air();
		else return null;
	}
